        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Editar Carta</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex flex-col md:flex-row gap-6">
                <div className="flex-shrink-0">
                  <div className="w-full md:w-64 h-auto md:h-[22rem] bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex items-center justify-center overflow-hidden border-2 border-gray-300 shadow-lg">
                    {formData.imageUrl ? (
                      <img
                  ...
                  <p className="text-xs text-gray-500 text-center mt-2">Vista previa de la carta</p>
                </div>
                ...
                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-800 mb-2">
                      Coste {formData.type === 'ORO' && <span className="text-gray-500 font-normal">(dejar vacío para oros)</span>}
                    </label>
                    <input
                      type="number"
                      value={formData.cost}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      readOnly
                      className="w-full px-4 py-2.5 bg-gray-100 border-2 border-gray-300 rounded-lg text-gray-600 cursor-not-allowed"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-gray-800 mb-2">
