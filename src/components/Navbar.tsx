          ...
          >
            ...
            <div className="relative w-12 h-12 flex items-center justify-center">
              ...
              <img 
                ...
                className="w-10 h-10 relative z-10 drop-shadow-[0_0_8px_rgba(244,196,48,0.5)] group-hover:drop-shadow-[0_0_12px_rgba(244,196,48,0.7)] transition-all"
              />
            </div>
            <div className="flex flex-col">
              <span className="text-xl font-bold text-[#F4C430] tracking-wide">El Signo Amarillo</span>
